...
BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1002041069552")).split())) 
STREAM_LOGS = environ.get('STREAM_LOGS','-1001992000183')
...
class Config(object):
	...
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6670339021:AAG1QmKyq_2yeEYJlw5O_SPr6AMrYm23ThY")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "MissRozy_BOT")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002116594511"))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "1439022100"))
	DATABASE_URL = os.environ.get("DATABASE_URL","MovieTimeHD1@cluster0.trfqzij.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001688675040")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001688675040")
	BANNED_USERS = set(int(x) for x in os.environ.get("BANNED_USERS", "1234567890").split())
	FORWARD_AS_COPY = bool(os.environ.get("FORWARD_AS_COPY", True))
	BROADCAST_AS_COPY = bool(os.environ.get("BROADCAST_AS_COPY", False))
	LAZY_CHANNEL = int(os.environ.get('LAZY_CHANNEL',"-1001688675040"))
  ...
  # LP_CUSTOM_TEMPLATE= os.environ.get("LP_CUSTOM_TEMPLATE","{file_name} - example \n\n Please Upadate this template acording to you @LazyDeveloperr ")
	BANNED_CHAT_IDS = list(set(int(x) for x in os.environ.get("BANNED_CHAT_IDS", "-10019920001839 -1002041069552").split()))
